...
def play(user):
    ...
    while True:
        ...
        while True:
            speech = 'Graphics/10speech' + str(curSpeech) + '.png'
            try:
            ...
            if curSpeech == 1:
                imgX = 650
                imgY = 230
                window.blit(snowpeaImg, (imgX,imgY))
    ...
    def victory():
        ...
        while True:
            curSpeech = 0
            while True:
                speech = 'Graphics/11speech' + str(curSpeech) + '.png'
    ...
    while True:
        ...
        slotList.append(potatominePacket(4))
        slotList.append(snowpeaPacket(5))
                            ...
                            if mRow != None and mCol != None:
                                ...
                                if gField.board[mRow][mCol] == None:
                                    #the current space is not occupied
                                        ...
                                        p = curP.makeNewPlant(mRow, mCol)
                                        if curSun >= p.cost:
                                            curP.curCooldown = curP.cooldown
                                            gField.board[mRow][mCol] = p
                                            plantsList.append(p)
                                            curSun -= p.cost
                                            curSelectedSlot = None
                                            plantingSound.play()
