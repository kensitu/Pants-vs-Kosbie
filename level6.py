...
def play(user):
    ...
    laughSound = pygame.mixer.Sound('Sounds/laugh.ogg')
    ...
    while True:
        ...
        while True:
            speech = 'Graphics/12speech' + str(curSpeech) + '.png'
            try:
    ...
    def victory():
        ...
        while True:
            curSpeech = 0
            while True:
                speech = 'Graphics/13speech' + str(curSpeech) + '.png'
    ...
    while True:
        ...
        sunList = []
        slotList = []
        slotList.append(cherrybombPacket(0))
        ...
        pygame.mixer.music.load('Sounds/bossmusic.ogg')
        pygame.mixer.music.play(-1, 0.0)
